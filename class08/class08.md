...
the unsupervised learning techniques covered in class. We will extend
...
Hierarchical clustering previous to PCA makes B and M samples group
together in one single cluster, having too many false negatives.
Therefore, the combined method works better.
